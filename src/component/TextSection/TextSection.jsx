...
export default function Text_section(){
    return(
        ...
        <h2 className="bold"><strong>Order food and groceries online from the best restaurants and shops on foodpanda</strong></h2>
        ...
        <br />
        <h2 className="bold"><strong>What's new?</strong></h2>
        ...
        <h2 className="bold"><strong>Frequently Asked Questions</strong></h2>
        <h2 className="bold"><strong>How can I get foodpanda delivery?</strong></h2>
        ...
        <h2 className="bold"><strong>Which takeout restaurants open now near me?</strong></h2>
        ...
        <h2 className="bold"><strong>Does foodpanda deliver 24 hours?</strong></h2>
        ...
        <h2 className="bold"><strong>Can you pay cash for foodpanda?</strong></h2>
        <p>Yes, you can pay cash on delivery for foodpanda in Pakistan.</p>
        <h2 className="bold"><strong>How can I pay foodpanda online?</strong></h2>
        <p>You can pay online while ordering at foodpanda Pakistan by using a credit or debit card or PayPal</p>
        <h2 className="bold"><strong>Can I order foodpanda for someone else?</strong></h2>
        ...
        <h2 className="bold"><strong>How much does foodpanda charge for delivery?</strong></h2>
        ...
        <h2 className="bold"><strong>What restaurants let you order online?</strong></h2>
        ...
        <h2 className="bold"><strong>Does foodpanda have minimum order?</strong></h2>
        ...
        <h2 className="bold"><strong>What is the difference between delivery and Pick-Up?</strong></h2>
        ...
        <h2 className="bold"><strong>Order food and groceries online with foodpanda now and enjoy a great dining experience!</strong></h2>
    </div>
    )
}